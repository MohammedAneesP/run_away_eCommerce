...
class ProfileScreen extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) { WidgetsBinding.instance.addPostFrameCallback((_) {
          ...
          BlocBuilder<DisplayingAllOrdersBloc, DisplayingAllOrdersState>(
            builder: (context, state) {
              if (state.isLoading == true) {
                ...
                return SliverToBoxAdapter(child: const Center(child: Text("No orders made yet!")));
              } else {
